...
const BACKGROUND_TOKENS = [
  '--ubits-bg-active','--ubits-bg-active-button','--ubits-bg-1','--ubits-bg-2','--ubits-bg-3','--ubits-bg-4','--ubits-bg-5','--ubits-bg-dim','--ubits-bg-disabled'
] as const;

const meta: Meta = {
  title: 'Tokens/Colors/Background Colors',
  tags: ['autodocs'],
};
export default meta;
