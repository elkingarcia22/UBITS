...
const TEAL_TOKENS = [
  '--ubits-fg-teal-subtle','--ubits-fg-teal-subtle-inverted','--ubits-fg-teal-subtle-hover','--ubits-fg-teal-subtle-inverted-hover',
  '--ubits-fg-teal-subtle-static','--ubits-fg-teal-subtle-static-inverted','--ubits-fg-teal-subtle-static-hover','--ubits-fg-teal-subtle-static-inverted-hover',
] as const;

const meta: Meta = {
  title: 'Tokens/Colors/Teal Foregrounds',
  tags: ['autodocs'],
};
export default meta;
