...
const BLUE_TOKENS = [
  '--ubits-fg-blue-subtle','--ubits-fg-blue-subtle-inverted','--ubits-fg-blue-subtle-hover','--ubits-fg-blue-subtle-inverted-hover',
  '--ubits-fg-blue-subtle-static','--ubits-fg-blue-subtle-static-inverted','--ubits-fg-blue-subtle-static-hover','--ubits-fg-blue-subtle-static-inverted-hover',
] as const;

const meta: Meta = {
  title: 'Tokens/Colors/Blue Foregrounds',
  tags: ['autodocs'],
};
export default meta;
