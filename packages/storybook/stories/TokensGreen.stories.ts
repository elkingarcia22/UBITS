...
const GREEN_TOKENS = [
  '--ubits-fg-green-subtle','--ubits-fg-green-subtle-inverted','--ubits-fg-green-subtle-hover','--ubits-fg-green-subtle-inverted-hover',
  '--ubits-fg-green-subtle-static','--ubits-fg-green-subtle-static-inverted','--ubits-fg-green-subtle-static-hover','--ubits-fg-green-subtle-static-inverted-hover',
] as const;

const meta: Meta = {
  title: 'Tokens/Colors/Green Foregrounds',
  tags: ['autodocs'],
};
export default meta;
