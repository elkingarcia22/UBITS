...
const PINK_TOKENS = [
  '--ubits-fg-pink-subtle','--ubits-fg-pink-subtle-inverted','--ubits-fg-pink-subtle-hover','--ubits-fg-pink-subtle-inverted-hover',
  '--ubits-fg-pink-subtle-static','--ubits-fg-pink-subtle-static-inverted','--ubits-fg-pink-subtle-static-hover','--ubits-fg-pink-subtle-static-inverted-hover',
] as const;

const meta: Meta = {
  title: 'Tokens/Colors/Pink Foregrounds',
  tags: ['autodocs'],
};
export default meta;
