...
const ROSE_TOKENS = [
  '--ubits-fg-rose-subtle','--ubits-fg-rose-subtle-inverted','--ubits-fg-rose-subtle-hover','--ubits-fg-rose-subtle-inverted-hover',
  '--ubits-fg-rose-subtle-static','--ubits-fg-rose-subtle-static-inverted','--ubits-fg-rose-subtle-static-hover','--ubits-fg-rose-subtle-static-inverted-hover',
] as const;

const meta: Meta = {
  title: 'Tokens/Colors/Rose Foregrounds',
  tags: ['autodocs'],
};
export default meta;
