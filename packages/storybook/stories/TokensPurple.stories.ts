...
const PURPLE_TOKENS = [
  '--ubits-fg-purple-subtle','--ubits-fg-purple-subtle-inverted','--ubits-fg-purple-subtle-hover','--ubits-fg-purple-subtle-inverted-hover',
  '--ubits-fg-purple-subtle-static','--ubits-fg-purple-subtle-static-inverted','--ubits-fg-purple-subtle-static-hover','--ubits-fg-purple-subtle-static-inverted-hover',
] as const;

const meta: Meta = {
  title: 'Tokens/Colors/Purple Foregrounds',
  tags: ['autodocs'],
};
export default meta;
